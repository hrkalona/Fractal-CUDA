...
void (*ptr_function)(Image*, Color*, int, int, double, double, double, int) = NULL;
void (*ptr_function2)(Image*, Color*, int, int, double, double, double, int, int, int*) = NULL;
...
void calculateFractal(double xCenter, double yCenter, double size, int max_iterations, int palette_size, int tile_size);
void saveBMPImage(void);
__global__ void MandelbrotGPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size);
__global__ void Newton4GPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size);
__global__ void SpiderGPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size);
__global__ void LambdaGPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size);
__global__ void TiledMandelbrotGPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size, int tile_size, int *d_not_calculated);
__global__ void TiledNewton4GPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size, int tile_size, int *d_not_calculated);
__global__ void TiledSpiderGPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size, int tile_size, int *d_not_calculated);
__global__ void TiledLambdaGPU(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double xcenter_size_2, double ycenter_size_2, double temp_size_image_size, int image_size, int tile_size, int *d_not_calculated);
__global__ void convolve2D(Image *in, Image *out, int image_size, float* kernel, int kernel_size);
__device__ void inline Mandelbrot(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size);
__device__ void inline Newton4(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size);
__device__ void inline Spider(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size);
__device__ void inline Lambda(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size);
...
__device__ void inline Mandelbrot(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size) {
  ...
  double z_re = re, z_im = im, c_re = re, c_im = im, z_re_temp, squared_re, squared_im;
...
__device__ void inline Newton4(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size) {
  ...
  double temp, temp2, temp3, divide_re, divide_im, dz_re, dz_im, old_re, old_im, temp_zre_oldre, temp_zim_old_im;
  int iterations_palette_size;
...
__device__ void inline Spider(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size) {
  int iterations = 0, bailout = 4, temp_trans;
  double z_re = re, z_im = im, c_re = re, c_im = im, temp_re, squared_re, squared_im;
  int iterations_palette_size;
  unsigned char temp = 0;
...
__device__ void inline Lambda(Image *d_image, Color *d_palette, int max_iterations, int palette_size, double re, double im, int i, int j, int image_size) {
  int iterations = 0, bailout = 4, temp_trans;
  double z_re = 0.5, z_im = 0, c_re = re, c_im = im, temp_re, temp_im, temp_re2, temp_im2;
  int iterations_palette_size;
  unsigned char temp = 0;
